...
*SimBIDS* is a *NiPreps* application, and abides by the
...
We believe that *SimBIDS* must be free to use, inspect, and critique.
...
.. automodule:: simbids.workflows.base
