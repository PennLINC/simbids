# simbids documentation build configuration file, created by
...
# Notes on SimBIDS-specific style:
...
# -----------------------------------------------------------------------------
bibtex_bibfiles = ['../src/simbids/data/boilerplate.bib']
bibtex_style = 'unsrt'
...
latex_documents = [
    (master_doc, 'simbids.tex', 'SimBIDS Documentation', author, 'manual'),
]
...
man_pages = [(master_doc, 'simbids', 'SimBIDS Documentation', [author], 1)]
